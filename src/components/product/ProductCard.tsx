    ...
    <>
      ...
      >
        ...
        <div className="relative aspect-square overflow-hidden bg-gray-100">
          ...
          {hasMultipleVariants && (
            <div className="absolute top-2 right-2 bg-pink-600 text-white px-2 py-1 rounded-full text-xs font-medium shadow-lg">
          ...
          {totalQuantity > 0 && !hasMultipleVariants && (
            <div className={clsx(
              ...
              isOutOfStock ? "bg-pink-600" : "bg-[#b55ca6]"
            )}>
              {totalQuantity}
            </div>
          )}
        ...
        <div className="p-3 sm:p-4">
          ...
          <div className="mb-2">
            {hasMultipleVariants && priceRange ? (
              <div>
                <span className="text-base sm:text-lg font-bold text-[#a04792]">
              ...
              <>
                ...
                <span className="text-base sm:text-lg font-bold text-[#a04792] ml-2">
          ...
          {hasMultipleVariants ? (
            <button
              ...
              className={clsx(
                ...
                'bg-[#b55ca6] text-white active:bg-[#9c4a8f] active:scale-95'
              )}
            >
              Ver opciones
            </button>
            ...
            <button
              ...
              className={clsx(
                'w-full py-2 rounded-full font-medium text-sm transition-all duration-200 touch-target',
                isOutOfStock
                  ? 'bg-pink-600 text-white active:bg-pink-700 active:scale-95'
                  : 'bg-[#b55ca6] text-white active:bg-[#9c4a8f] active:scale-95',
                isAdding && 'scale-105'
              )}
            >
