...
export function ProductCard({ product, onOpenDetail }: ProductCardProps) {
  ...
  return (
    <div
      className="group relative bg-white rounded-2xl border border-[color:var(--color-hairline)] overflow-hidden transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_14px_40px_-18px_rgba(45,31,45,0.25)] active:scale-[0.99] cursor-pointer"
